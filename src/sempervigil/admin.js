...
function wireDashboard() {
  ...
  function renderJobCounts(counts, jobTypes, countsSince, queueable) {
    const pipelineOrder = [
    ...
    const types = [
      ...pipelineOrder.filter((type) => typeSet.has(type)),
      ...allTypes.filter((type) => !pipelineOrder.includes(type)),
    ];
